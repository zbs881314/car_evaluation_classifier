...
l1 = tf.layer.dense(tfx, 128, tf.nn.relu, name="l1")
l2 = tf.layer.dense(l1, 128, tf.nn.relu, name="l2")
out = tf.layer.dense(l2, 4, name="l3")
...
#training
plt.ion()
fig, (ax1, ax2) = plt.subplot(1,2,figsize=(8,4))
accuracies, steps = [], []
for t in range(4000):
    ...
    if t % 50 == 0:
        ...
        ax1.set_xticks(range(4), ["accepted", "goog", "unaccepted", "very good"])
